...
<Meta title="Components/GlobalStyle" />

# GlobalStyle

The `GlobalStyle` component is a wrapper around the `createGlobalStyle` function from `styled-components`.<br />
It allows you to apply a consistent style across your entire application, including:

- CSS reset
- font definition
- custom accent color
- custom selection
- and custom focus styles.
